...
function initialize(position) {
  ...
  var currentPositionImage ='http://www.dcs.bbk.ac.uk/lo/mad/madexamples/session5/classexamples/branchmap/icons/current_pos.png';
  ...
  var churchillPosition = new google.maps.Marker({
   ...
   var churchillHotelInfo ='<div id="mappopup">'+
      ...
      '<a href="http://www.dcs.bbk.ac.uk/lo/mad/madexamples/session5/classactivities/zedlandhotels/churchill-hotel.html">Details</a> '+
      '</div>'; 
